...
var OLControl = (function (_OLComponent) {
  function OLControl(props) {
    _classCallCheck(this, OLControl);

    _get(Object.getPrototypeOf(OLControl.prototype), "constructor", this).call(this, props);
    this.control = this.createControl(props);
  }

  _inherits(OLControl, _OLComponent);

  _createClass(OLControl, {
    componentDidMount: {
    ...
    createControl: {
      value: function createControl(props) {
        throw new TypeError("You must override createControl() in classes derived " + "from OLControl");
      }
    }
  });
