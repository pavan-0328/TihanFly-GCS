...
var ImageArcGISRest = (function (_OLComponent) {
  function ImageArcGISRest(props) {
    _classCallCheck(this, ImageArcGISRest);

    _get(Object.getPrototypeOf(ImageArcGISRest.prototype), "constructor", this).call(this, props);
    this.source = new ol.source.ImageArcGISRest(Object.assign({}, this.props));
  }

  _inherits(ImageArcGISRest, _OLComponent);
...
module.exports = ImageArcGISRest;
