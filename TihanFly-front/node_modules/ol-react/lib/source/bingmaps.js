...
var BingMaps = (function (_OLComponent) {
  function BingMaps(props) {
    _classCallCheck(this, BingMaps);

    var spreadedProps = Object.assign({}, props);
    spreadedProps.key = spreadedProps.apiKey;
    delete spreadedProps.apiKey;

    _get(Object.getPrototypeOf(BingMaps.prototype), "constructor", this).call(this, props);

    this.source = new ol.source.BingMaps(spreadedProps);
  }

  _inherits(BingMaps, _OLComponent);
