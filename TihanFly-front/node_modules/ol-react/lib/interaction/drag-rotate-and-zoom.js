...
var DragRotateAndZoom = (function (_OLInteraction) {
  function DragRotateAndZoom() {
  ...
  _inherits(DragRotateAndZoom, _OLInteraction);

  _createClass(DragRotateAndZoom, {
    createInteraction: {
...
module.exports = DragRotateAndZoom;
